...
public class GuiScreenWizardInitiateDismissal extends GuiContainer {
	private static final ResourceLocation GUI_BACKGROUND = new ResourceLocation(ApprenticeArcana.MODID, "textures/gui/wizard_dismiss.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		this.fontRenderer.drawSplitString(I18n.format("gui.apprenticearcana:dismiss_wizard_confirmation", this.wizard.getDisplayNameWithoutOwner().getFormattedText()), 5, 13, 170, 4210752);
		this.fontRenderer.drawSplitString(I18n.format("gui.apprenticearcana:dismiss_wizard_type_name", this.wizard.getDisplayNameWithoutOwner().getFormattedText()), 5, 13 + 95,170, 4210752);
	}
	...
	public void initGui() {
		...
		this.buttonList.add(this.confirmButton = new GuiButton(0, left + 100, top + 150, I18n.format("gui.apprenticearcana:confirm_button")));
		this.buttonList.add(this.cancelButton = new GuiButton(1, left + 20, top + 150, I18n.format("gui.apprenticearcana:cancel_button")));
