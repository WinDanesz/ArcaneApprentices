...
public class GuiScreenCharmItinerary extends GuiContainer {
	private static final ResourceLocation GUI_BACKGROUND = new ResourceLocation(ApprenticeArcana.MODID, "textures/gui/charm_itinerary.png");
		...
		if (playerSP != null) {
			...
			for (StoredEntity entity : PlayerData.getAdventuringApprentices(playerSP)) {
				if (entity.nbtTagCompound.hasKey("CustomName")) {
					...
					this.fontRenderer.drawSplitString(I18n.format("gui.apprenticearcana:charm_itinerary_entry", name, minutes), 20, i, 105, 1);
