...
public enum Speech {
	...
	WIZARD_NEARBY_DISPENSER_SPELL_CAST(2),
	...
	WIZARD_OWNER_SPELL_CAST_COMPLIMENT_LOW_TIER(4),
	WIZARD_COMBAT(8),
	...
	GREET(5),
	GREET_HANDBOOK_HINT(5),
	PLAYER_GIVES_HANDBOOK(14),
	PLAYER_GIVES_HANDBOOK_WITHOUT_REQUIREMENTS(14),
	WIZARD_FINISHED_SPELL_LEARNING(11),
	WIZARD_USES_MANA_FLASK(6),
	OWNER_GIVE_MANA_FLASK(5),
	WIZARD_NETHER_REMARKS(5),
	WIZARD_END_REMARKS(3),
	WIZARD_BIOME_REMARKS(6),
	GIVE_FOUND_ITEM(6),
	GIVE_FOUND_ITEM_RARE(5),
	WIZARD_SPELL_FORFEIT_SELF(7),
	WIZARD_SPELL_FORFEIT_MASTER(4);
	...
	public String getString() {
		return "message.arcaneapprentices:" + this.toString().toLowerCase();
	}

	public String getRandom() {
		return getString() + "_" + ArcaneApprentices.rand.nextInt(count);
	}
