...
public class ContainerWizardInititateDismissal extends ContainerWizardBase {
	public final EntityWizardInitiate wizard;

	public ContainerWizardInititateDismissal(final EntityWizardInitiate wizard, EntityPlayer player) {
		this.wizard = wizard;
	}
