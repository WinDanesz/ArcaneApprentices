...
public class GuiScreenWizardInitiateAdventure extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		//	this.fontRenderer.drawSplitString(I18n.format("gui.arcaneapprentices:wizard_journey_gui_info", this.wizard.getDisplayNameWithoutOwner().getFormattedText()), 5, 88, 170, 4210752);
		this.fontRenderer.drawSplitString(I18n.format("gui.arcaneapprentices:distance_to_travel"), 5, 140 - 32, 170, 4210752);
		this.fontRenderer.drawSplitString(I18n.format("gui.arcaneapprentices:what_to_do"), 5, 180 - 35, 170, 4210752);
	...
	public void initGui() {
		...
		this.buttonList.add(this.mediumDuration = new GuiButtonWithDescription(4, left + 68, top + 155 - offset, 40, 20, I18n.format("gui.arcaneapprentices:medium"), "medium_duration", 1));
		this.buttonList.add(this.longDuration = new GuiButtonWithDescription(5, left + 110, top + 155 - offset, 40, 20, I18n.format("gui.arcaneapprentices:long"), "long_duration", 1));
		this.buttonList.add(this.gatheringButton = new GuiButtonWithDescription(6, left + 15, top + 190 - offset, 70, 20, I18n.format("gui.arcaneapprentices:gather"), "gather", 2));
		this.buttonList.add(this.mobSlayingButton = new GuiButtonWithDescription(7, left + 90, top + 190 - offset, 70, 20, I18n.format("gui.arcaneapprentices:slay_mobs"), "slay_mobs", 2));

		// default adventure
		this.buttonList.add(this.journeyButton = new GuiButtonWithDescription(8, left + 15, top + 213 - offset, 70, 20, I18n.format("gui.arcaneapprentices:adventure"), "adventure", 2));
...
//			this.buttonList.add(this.treasureHuntButton = new GuiButtonWithDescription(9, left + 90, top + 213 - offset, 70, 20, I18n.format("gui.arcaneapprentices:treasure_hunt"), "treasure_hunt", 2));
		...
		for (GuiButton button : buttonList) {
			if (button instanceof GuiButtonWithDescription && button.isMouseOver()) {
				...
				if (button != infoButton) {
					...
					drawHoveringText(I18n.format("gui.arcaneapprentices:wizard_journey_gui_info", this.wizard.getDisplayNameWithoutOwner().getFormattedText()), tooltipX, tooltipY);
				}
			}
		}
	...
	private static class GuiButtonWithDescription extends GuiButton {
		...
		public String getDescriptionLanguageKey() {
			return "gui." + ArcaneApprentices.MODID + ":" + buttonCodeName + ".description";
		}
	}
