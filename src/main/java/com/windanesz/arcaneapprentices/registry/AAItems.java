...
public final class AAItems {
	...
	public static final Item charm_focus_of_clarity = placeholder();
	...
	public static void register(RegistryEvent.Register<Item> event) {
		...
		ItemRegistry.registerItemArtefact(registry, "charm_seal_of_fate", ArcaneApprentices.MODID, new ItemArtefact(EnumRarity.UNCOMMON, ItemArtefact.Type.CHARM));
		...
		ItemRegistry.registerItemArtefact(registry, "charm_focus_of_clarity", ArcaneApprentices.MODID, new ItemArtefact(EnumRarity.RARE, ItemArtefact.Type.CHARM));
